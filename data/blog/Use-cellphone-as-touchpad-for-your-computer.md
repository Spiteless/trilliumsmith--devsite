...
Google Chrome has a handy dandy featue that easily lets you remote desktop from one device to another. It's aptly named Chrome Remote Desktop, and with the accompanying mobile app for both iPhone and Android, you can add desktop/laptop devices to your Google Profile (connected to an email), and contorl them from any device logged into Chrome Remote Desktop.
